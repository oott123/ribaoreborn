...
//BASIC AUTH
if($this->setopt['basicAuth']){
	curl_setopt($ch,CURLOPT_USERPWD,$this->setopt['basciAuthUser'].":".$this->setopt['basciAuthPwd']); 
}
...
//设置 HTTP USERAGENT
$userAgent = $this->setopt['userAgent'] ? $this->setopt['userAgent'] : 'Spider/Best33.com';
